...
public class C04_webtables extends TestBase {
    ...
    //i made 2 purchases in the last week from your london stratford westfield store
    //worth more than 200 pounds and i didnt receive any points from my purchases and that
    //200 points is vital because it helps get to the next level
}
